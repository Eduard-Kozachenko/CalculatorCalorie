...
public class CalculationUseCase {
    ...
    public static String operationMale(double weight, double height, double age, int level) {
    ...
    public static String operationFemale(double weight, double height, double age, int level) {
        User user = new User(weight, height, age);
